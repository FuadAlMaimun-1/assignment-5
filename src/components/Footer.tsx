        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mb-12">
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <div className="flex gap-4 pt-2">
              <a href="#" className="text-xs text-gray-500 hover:text-gray-900 font-medium transition-colors">GitHub</a>
              <a href="#" className="text-xs text-gray-500 hover:text-gray-900 font-medium transition-colors">Twitter</a>
              <a href="#" className="text-xs text-gray-500 hover:text-gray-900 font-medium transition-colors">LinkedIn</a>
            </div>
          </div>
